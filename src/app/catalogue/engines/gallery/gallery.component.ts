...
@Component({
  selector: 'app-catalogue-engines-gallery',
  templateUrl: './gallery.component.html'
})
@Injectable()
export class CatalogueEnginesGalleryComponent implements OnInit, OnDestroy {
        ...
        this.itemParentService
          .getItems({
            fields: [
              ...
              'item.can_edit_specs,item.specs_url,item.has_child_specs,item.has_specs',
              'item.twins_groups',
